...
from .types import ServiceKey, normalize_type
...
def get_class_constructor_dependencies(cls: Type[Any]) -> Dict[str, Type[Any]]:
    ...
    try:
        ...
        raise InjectionError(f"Failed to analyze constructor dependencies for {cls}: {e}")
...
def is_injectable_class(cls: Type[Any]) -> bool:
    ...
    try:
        ...
        return (
            ...
            cls.__init__ is not object.__init__ and  # Skip object's __init__
            is_injectable_function(cls.__init__)
        )
    except (ValueError, TypeError):
        return False
