...
from .scopes import ScopeManager, get_scope_manager


class DependencyResolver:
    """Resolves dependencies and manages dependency graphs."""
    
    def __init__(self, registry: ServiceRegistry, scope_manager: Optional[ScopeManager] = None) -> None:
    ...
    def _resolve_binding(self, binding: ServiceBinding) -> Any:
        ...
        return self.scope_manager.get_instance(
            key=binding.service_type,
            factory=factory,
            scope_name=binding.scope
        )
    
    def _resolve_factory(self, service_type: ServiceKey, factory: Callable[..., Any]) -> Any:
    ...
    def _create_instance(self, implementation: Any) -> Any:
        ...
        raise InjectionError(f"Don't know how to create instance from: {implementation}")
