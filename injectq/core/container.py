...
from typing import Any, Dict, List, Optional, Type, Union, Callable, overload
...
from .scopes import ScopeManager, ScopeType, get_scope_manager
...
class InjectQ:
    ...
    def __init__(self, modules: Optional[List[Any]] = None) -> None:
        ...
        self._scope_manager = get_scope_manager()
