...
from ..utils import ServiceKey


@contextmanager
def override_dependency(service_type: ServiceKey, override_value: Any, container: Optional[InjectQ] = None) -> Iterator[None]:
    """
        ...
        if service_type not in self._instances:
            ...
            class MockService:
                ...
                def __getattr__(self, name):
                    ...
                    def mock_method(*args, **method_kwargs):
...
def create_test_module(bindings: dict[ServiceKey, Any]) -> "TestModule":
    ...
    """
    from ..modules import SimpleModule
